...
import 'package:allay/screens/controls/volunteer_chat_reply_screen.dart';
...
class VolunteerPickedChatScreen extends StatefulWidget {
  ...
  @override
  _VolunteerPickedChatScreenState createState() => _VolunteerPickedChatScreenState();
}
...
class _VolunteerPickedChatScreenState extends State<VolunteerPickedChatScreen> {
  ...
  void fetch()async{
    ...
    pickedChats = Provider.of<VolunteerChat>(context, listen: false).volunteerPickedChats;
    setState(() {
      isLoading = false;
    });
  }
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: ListTile(
                            ...
                            onTap: ()=>Navigator.of(context).pushNamed(VolunteerChatReplyScreen.routeName,arguments:pickedChats[i].userChatId ),
